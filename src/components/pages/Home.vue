<template>
  <div class="h-screen">
    <p class="font-semibold text-xl p-4">
      Hi,
      {{
    ...
    <center v-if="$store.state.monoid != 0" class="">
      ...
      <div class="rounded-lg shadow-lg w-3/4 mt-4 p-4">
        <center>
          <p class="text-3xl font-semibold">
            ₦{{ $store.state.account.balance }}
          </p>
          <p class="uppercase text-sm text-blue-400 font-light">
      ...
      <div class="w-3/4 mt-4">
        <p class="font-semibold text-xl text-left">
          <span>How you spent your ₦₦ </span>
        </p>
        <div
          :key="index"
        ...
        >
          ...
          <p
            class="uppercase"
            :class="
              $store.state.statement[index]['type'] == 'credit'
                ? 'text-green-500'
                : 'text-red-500'
            "
          >
            {{ $store.state.statement[index]["type"] }}
          </p>
